...
abstract class Repository
{
    ...
    {
        $tableNotExist = true;
        $query = "SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = '$table' AND TABLE_SCHEMA = 'TTGM' ;";
     ...
     */
    protected function createTableIfNotExistes(string $table, string $tableQuery, string $insertQuery)
    {
